...
function getTaskPhaseLabel(phase: TaskPhase): string {
  switch (phase) {
    case "NO_TASK": return "Aktif Görev Yok";
    case "TASK_RECEIVED": return "Görev Alındı";
    case "PROCESSING": return "Görev İşleniyor";
    case "GOING_TO_PICKUP": return "Alma Noktasına Gidiliyor";
    case "PICKUP_ALIGNMENT": return "Alma Noktasında Hizalanıyor";
    case "LOAD_PICKED": return "Yük Alındı";
    case "GOING_TO_GATE": return "Kapı Bölgesine Gidiliyor";
    case "WAITING_FACTORY_COMMAND": return "Fabrika Komutu Bekleniyor";
    case "PASSING_GATE": return "Kapıdan Geçiliyor";
    case "GOING_TO_DROPOFF": return "Bırakma Noktasına Gidiliyor";
    case "DROPOFF_ALIGNMENT": return "Bırakma Noktasında Hizalanıyor";
    case "LOAD_DROPPED": return "Yük Bırakıldı";
    case "RETURNING_TO_START": return "Başlangıca Dönülüyor";
    case "COMPLETED": return "Görev Tamamlandı";
    case "ERROR": return "Görev Hatası";
...
function getTaskPhaseClass(phase: TaskPhase): string {
  switch (phase) {
    ...
    case "WAITING_FACTORY_COMMAND": return "task-waiting";
    case "NO_TASK": return "task-idle";
    default: return "task-active";
  }
}

export function TaskRoutePanel({ task }: Props) {
  const [activeRoute, setActiveRoute] = useState<DefinedRoute | null>(() => getActiveRoute());
